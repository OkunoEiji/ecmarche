        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    {{-- ファイルの変更はないため、enctype="multipart/form-data"はいらない --}}
                    <form method="post" action="{{ route('owner.images.update', ['image'=>$image->id]) }}">
                        ...
                        <div class="-m-2">
                          <div class="p-2 w-1/2 mx-auto">
                            <div class="relative">
                              {{-- タイトルのみの変更なので、for、id、name=title,type=text、multiple accept='image/png,image/jpeg,image/jpg'はいらない --}}
                          ...
                          <div class="p-2 w-full flex justify-around mt-4">
                            <button type="button" onclick="location.href='{{ route('owner.images.index') }}'" class="bg-green-400 border-0 py-2 px-8 focus:outline-none hover:bg-green-500 rounded text-lg">戻る</button>
