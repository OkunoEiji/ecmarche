                    ...
                    <div class="lg:flex lg:justify-around">
                        <div class="lg:flex items-center">
                            <select name="category" class="mb-2 lg:mb-0 lg:mr-2">
                                <option value="0" @if(\Request::get('category') === '0') selected @endif>未選択</option>
                            ...
                            <div class="flex space-x-2 items-center">
                                ...
                                <div><button class="ml-auto text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded">検索</button></div>
                            </div>
                        </div>
                    <div class="flex">
                        <div>
