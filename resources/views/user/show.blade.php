<x-app-layout>
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-4 text-center">
                        @if($product->shop->filename !== null)
                            <img class="mx-auto w-40 h-40 object-cover rounded-full" src="{{ asset('storage/products/' . $product->shop->filename )}}">
                        @else
                            <img src="">
                        @endif
                    </div>
                    <div class="mb-4 text-center">
                        {{-- このボタンはpost通信の影響をさせないため、type="button" --}}
    ...
    <div class="modal micromodal-slide" id="modal-1" aria-hidden="true">
        <div class="modal__overlay z-50 z-index" tabindex="-1" data-micromodal-close>
