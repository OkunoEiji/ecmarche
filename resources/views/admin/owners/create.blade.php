                            ...
                            <div class="-m-2">
                              <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                  ...
                                  {{-- 名前は必須の為、inputタグにrequiredの属性が必要 --}}
                              ...
                              <div class="p-2 w-full flex justify-around mt-4">
                                <button onclick="location.href='{{ route('admin.owners.index') }}'" class="bg-green-400 border-0 py-2 px-8 focus:outline-none hover:bg-green-500 rounded text-lg">戻る</button>
